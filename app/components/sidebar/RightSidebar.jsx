...
export const RightSidebar = () => {
    const [attacks] = useState([
      ...
      const handleDefenseToggle = (id) => {
        setDefenses(defenses.map((defense) => (defense.id === id ? { ...defense, enabled: !defense.enabled } : defense)));
      };
          ...
          <div className="space-y-4  pl-6 pr-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between w-full p-4 bg-[#2A2A2A] rounded-lg">
                ...
                <button className="p-2 hover:bg-[#333333] rounded transition-colors" aria-label="Configure rate limiting">
